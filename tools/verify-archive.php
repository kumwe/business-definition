...
$requiredRoots = ['CHANGELOG.md', 'CHARTER.md', 'LICENSE', 'docs/release-record.md', 'README.md', 'composer.json'];
$requiredShipped = [
    ...
    'docs/dependency-release-gate.md',
    'docs/security.md',
    'examples/README.md',
    ...
    'docs/semantic-boundaries.md',
    'docs/formula-profile.md',
...
foreach ($symbols as $symbol => $entry) {
    ...
    if (
        !is_string($symbol)
        || !str_starts_with($symbol, 'Kumwe\\BusinessDefinition\\')
        || !is_string($file)
...
if (($composer['name'] ?? null) !== 'kumwe/business-definition') {
    $errors[] = 'The archived composer.json does not name kumwe/business-definition.';
}
